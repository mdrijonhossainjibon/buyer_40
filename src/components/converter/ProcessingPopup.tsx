...
export default function ProcessingPopup({ visible }: ProcessingPopupProps) {
  const [currentStep, setCurrentStep] = useState(0)
  const [progress, setProgress] = useState(0)

  const steps = [
    { icon: 'fa-check-circle', label: 'Verifying transaction', duration: 1000 },
    { icon: 'fa-exchange-alt', label: 'Processing conversion', duration: 1500 },
    { icon: 'fa-shield-alt', label: 'Securing transaction', duration: 1000 },
    { icon: 'fa-check-double', label: 'Finalizing...', duration: 500 }
  ]

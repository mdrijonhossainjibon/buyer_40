...
export default function ReferralPage() {
  ...
  const shareOnWhatsApp = () => {
    const text = encodeURIComponent(
      `🎉 Join me on Earn From Ads and start earning by watching ads! You'll get 0.015$ USDT bonus for referring! ${referralLink}`
    );
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 rounded-xl p-3 border border-blue-200 dark:border-blue-800 shadow-md">
              ...
              {isLoading ? (
                ...
                <p className="text-2xl font-black text-blue-600 dark:text-blue-400">{user.referralCount}</p>
              )}
            </div>

            <div className="bg-gradient-to-br from-green-50 to-emerald-100 dark:from-green-900/20 dark:to-emerald-800/20 rounded-xl p-3 border border-green-200 dark:border-green-800 shadow-md">
              <div className="flex items-center gap-2 mb-1">
              ...
              <p className="text-2xl font-black text-green-600 dark:text-green-400">$0.015</p>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-2.5">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg p-3 border border-gray-200 dark:border-gray-700 shadow-sm flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-[10px] text-gray-600 dark:text-gray-400">Get $0.015 USDT for each successful referral</p>
              </div>
            </div>
          </div>
        </div>

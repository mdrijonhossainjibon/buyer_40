...
import { fetchWithdrawHistoryRequest } from 'modules/withdrawHistory'
...
export default function WithdrawHistoryPopup() {
  ...
  useEffect(() => {
    if (user?.userId) {
      dispatch(fetchWithdrawHistoryRequest(user.userId))
    }
  }, [dispatch])
                      ...
                      >
                        ...
                        <div className="flex items-center justify-between mb-2">
                          <div className="flex items-center gap-3 flex-1">
                            {/* Status Icon */}
                            <div className={`w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0 ${transaction.status === 'completed' ? 'bg-green-100 dark:bg-green-900/30' :
                              ...
                              <svg className={`w-5 h-5 ${transaction.status === 'completed' ? 'text-green-600 dark:text-green-400' :
                          ...
                          <div className="text-right ml-3">
                            ...
                            <div className={`text-xs font-medium capitalize mt-0.5 ${transaction.status === 'completed' ? 'text-green-600 dark:text-green-400' :
                                transaction.status === 'processing' ? 'text-blue-600 dark:text-blue-400' :
                                  transaction.status === 'pending' ? 'text-yellow-600 dark:text-yellow-400' :
                                    'text-red-600 dark:text-red-400'
                              }`}>
